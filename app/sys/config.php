...
class Sys_Config
{
    ...
    private static $_run_mode_map = [
        DA_RUN_MODE_PRO => 'production',
        DA_RUN_MODE_DEV => 'development',
        DA_RUN_MODE_UT => 'unittest',
        DA_RUN_MODE_PRE=> 'pre-production',
    ];
    ...
    {
        return isset(self::$_run_mode_abbr_map[$run_mode])
